                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $role->name) }}"
                                required {{ in_array($role->name, ['admin', 'employee', 'customer']) ? 'readonly' : '' }}>
                            @if (in_array($role->name, ['admin', 'employee', 'customer']))
                                <div class="form-text small text-warning"><i class="fas fa-lock me-1"></i> Không thể đổi mã
                                    của chức vụ mặc định hệ thống</div>
                            @else
                                ...
                                <tbody>
                                    @php
                                        $modules = [
                                            ...
                                            'services' => 'Quản lý gói dịch vụ',
                                            'orders' => 'Quản lý đơn hàng',
                                            'payment_receipt' => 'Quản lý phiếu thu',
                                            // Recruitment
